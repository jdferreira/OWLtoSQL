...
class Unfolder implements OWLClassExpressionVisitorEx<RelationsStore> {
    ...
    public static void main(String[] args) {
        ...
        OWLObjectSomeValuesFrom x1 = df.getOWLObjectSomeValuesFrom(isPartOf, investigation);
        OWLObjectIntersectionOf x2 = df.getOWLObjectIntersectionOf(specimenCollection, x1);
        OWLObjectSomeValuesFrom x3 = df.getOWLObjectSomeValuesFrom(objectiveAchievedBy, x2);
        OWLObjectIntersectionOf x4 = df.getOWLObjectIntersectionOf(specimenCollectionObjective, x3);
        OWLObjectSomeValuesFrom x5 = df.getOWLObjectSomeValuesFrom(concretizes, x4);
        OWLObjectSomeValuesFrom x6 = df.getOWLObjectSomeValuesFrom(isBearerOf, x5);
        OWLObjectUnionOf x7 = df.getOWLObjectUnionOf(homoSapiens, organization);
        OWLObjectIntersectionOf x8 = df.getOWLObjectIntersectionOf(x6, x7);
        OWLObjectSomeValuesFrom x9 = df.getOWLObjectSomeValuesFrom(inheresIn, x8);
